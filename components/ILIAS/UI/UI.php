...
class UI implements Component\Component
{
    public function init(
        ...
        // we cannot do this, since this file will only be used to create the
        // component wiring. this snippet needs to be moved inside the UI
        // framework implementation somewhere.
        // $use[Language\Language::class]->loadLanguageModule('ui');
        ...
        $internal[UI\Implementation\Render\JavaScriptBinding::class] = static fn() =>
            new UI\Implementation\Render\ilJavaScriptBinding(
                new class () extends \ilGlobalPageTemplate {
