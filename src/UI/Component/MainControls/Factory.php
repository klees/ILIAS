...
interface Factory
{
     ...
     *
     *   composition: >
     *     The Footer is rendered empty or composed with a list of Links or Shy Buttons
     *     triggering_bs Round Trip Modals and optional text-parts. The footer is divided
     *     into three areas: sharing links, utility links and meta information.
     *     An empty Footer will not be rendered.
     *
     * context:
