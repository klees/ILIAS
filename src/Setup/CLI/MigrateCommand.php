...
class MigrateCommand extends Command
{
    ...
    public function configure()
    {
        ...
        $this->addOption("steps", "S", InputOption::VALUE_REQUIRED, "Run the selected migration with X steps. Pass " . Migration::INFINITE . " for all remaining steps.");
    ...
    protected function prepareEnvironmentForMigration(Environment $environment, Migration $migration, IOWrapper $io) : Environment
    {
